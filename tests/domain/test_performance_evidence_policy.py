...
def _support(posture, direction=DescriptiveDirection.INCREASED):
    return PerformanceEvidenceDecisionSupport(
        ...
        statistical_difference_direction=(DescriptiveDirection.UNAVAILABLE if posture is CombinedEvidencePosture.INFERENTIAL_EVIDENCE_UNAVAILABLE else direction),
