...
The decision-support composition layer may expose descriptive direction beside statistical evidence status, but must preserve disagreement and must not collapse the combination into a score, recommendation, policy mutation, or execution action.
